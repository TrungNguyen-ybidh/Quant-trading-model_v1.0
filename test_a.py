...
def main():
    ...
    #filtered_df.to_csv("BTC_backtest_results.csv")
    #print("✅ Results saved to_"+symbol+"_Backtest_results.csv (breakouts and entries only)")
